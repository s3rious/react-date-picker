...
function (_React$Component) {
  ...
  function YearView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getMonthsInYear", function (value) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderMonths", function (props, days) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderMonth", function (props, date) {
