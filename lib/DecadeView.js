...
function (_React$Component) {
  ...
  function DecadeView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getYearsInDecade", function (value) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderYears", function (props, days) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderYear", function (props, date, index, arr) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function (props, date, event) {
