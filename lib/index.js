...
function (_React$Component) {
  ...
  function DatePicker() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getViewOrder", function () {
      return _this.props.viewOrder || ['month', 'year', 'decade'];
    });

    _defineProperty(_assertThisInitialized(_this), "getViewName", function () {
      var view = _this.props.view != null ? _this.props.view : _this.state.view;
      return view || 'month';
    });

    _defineProperty(_assertThisInitialized(_this), "addViewIndex", function (amount) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getNextViewName", function () {
      return _this.getViewOrder()[_this.addViewIndex(1)];
    });

    _defineProperty(_assertThisInitialized(_this), "getPrevViewName", function () {
      return _this.getViewOrder()[_this.addViewIndex(-1)];
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "getViewFactory", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "getViewDate", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "prepareStyle", function (props) {
      return assign({}, props.defaultStyle, props.style);
    });

    _defineProperty(_assertThisInitialized(_this), "renderFooter", function (props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "gotoNow", function () {
      _this.gotoDate(+new Date());
    });

    _defineProperty(_assertThisInitialized(_this), "gotoSelected", function (props) {
      _this.gotoDate(props.date || +new Date());
    });

    _defineProperty(_assertThisInitialized(_this), "gotoDate", function (value) {
      _this.setView('month');

      _this.setViewDate(value);
    });

    _defineProperty(_assertThisInitialized(_this), "getViewColspan", function () {
      var map = {
        month: 5,
        year: 2,
        decade: 2
    ...
    _defineProperty(_assertThisInitialized(_this), "renderHeader", function (view, props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleRenderDay", function (date) {
      return (_this.props.renderDay || emptyFn)(date) || [];
    });

    _defineProperty(_assertThisInitialized(_this), "handleViewChange", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "setViewDate", function (moment) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getPrev", function () {
      var current = _this.getViewDate();
    ...
    _defineProperty(_assertThisInitialized(_this), "handleNavigation", function (direction, event) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleNavPrev", function (event) {
      _this.handleNavigation(-1, event);
    });

    _defineProperty(_assertThisInitialized(_this), "handleNavNext", function (event) {
      _this.handleNavigation(1, event);
    });
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      ...
      }, React.createElement(localView, viewProps)), this.renderFooter(props));
    }
  }]);
