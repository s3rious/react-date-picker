...
function (_React$Component) {
  ...
  function MonthView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "formatAsDay", function (moment, dayDisplayFormat) {
      return moment.format(dayDisplayFormat || 'D');
    });

    _defineProperty(_assertThisInitialized(_this), "getWeekStartMoment", function (value) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getDaysInMonth", function (value) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDays", function (props, days) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDay", function (props, date) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getWeekDayNames", function (props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderWeekDayNames", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function (props, date, timestamp, event) {
